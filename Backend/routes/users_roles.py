...
@users_roles.get("/users_roles/", response_model=List[schemas.users_roles.UserRol], tags=["Usuarios Roles"])
...
@users_roles.post("/users_roles/{id_user}/{id_rol}", response_model=schemas.users_roles.UserRol, tags=["Usuarios Roles"])
...
@users_roles.post("/users_roles/", response_model=schemas.users_roles.UserRol, tags=["Usuarios Roles"])
...
@users_roles.put("/users_roles/{id_user}/{id_rol}", response_model=schemas.users_roles.UserRol, tags=["Usuarios Roles"])
...
@users_roles.delete("/users_roles/{id_user}/{id_rol}", response_model=schemas.users_roles.UserRol, tags=["Usuarios Roles"])
