...
@rol.post("/roles/{id}", response_model=schemas.roles.Rol, tags=["Roles"])
...
@rol.put("/roles/{id}", response_model=schemas.roles.Rol, tags=["Roles"])
...
@rol.delete("/roles/{id}", response_model=schemas.roles.Rol, tags=["Roles"])
