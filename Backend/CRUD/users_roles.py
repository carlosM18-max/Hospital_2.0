...
def create_userrol(db: Session, userrol: schemas.users_roles.UserRolCreate):
    db_userrol = models.users_roles.UserRol(Usuario_ID=userrol.Usuario_ID, Rol_ID = userrol.Rol_ID, Estatus = userrol.Estatus, Fecha_Registro = userrol.Fecha_Registro, Fecha_Actualizacion = userrol.Fecha_Actualizacion)
    db.add(db_userrol)
    db.commit()
