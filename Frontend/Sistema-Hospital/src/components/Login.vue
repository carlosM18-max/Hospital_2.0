    ...
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div class="w-full p-8 lg:w-1/2">
            ...
            <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                ...
                <h1 class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">Iniciar Sesion con Google</h1>
            </a>
            <div class="mt-4 flex items-center justify-between">
                <span class="border-b w-1/5 lg:w-1/4"></span>
                <a href="#" class="text-xs text-center text-gray-500 uppercase">O logueate con tu usuario</a>
                <span class="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="/register" class="text-xs text-gray-500 uppercase">Crear Cuenta</a>
                <span class="border-b w-1/5 md:w-1/4"></span>
            </div>
        </div>
    </div>
