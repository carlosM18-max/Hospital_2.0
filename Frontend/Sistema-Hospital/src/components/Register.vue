...
<div class="py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-6xl">
        ...
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-700 text-center mb-5">Privilage Care</h2>
            <p class="text-xl text-gray-600 text-center">Crea una Cuenta!</p>
            <div class="mt-4">
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Genero</label>
                </div>
                <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-center">
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Sangre</label>
                </div>
                <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-center">
            ...
            <div class="mt-4">
                ...
                <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="date" />
            </div>
            <div class="mt-4">
                <div class="flex justify-between">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="/" class="text-xs text-gray-500 uppercase text-center">Ya tienes una cuenta? Inicia Sesion</a>
                <span class="border-b w-1/5 md:w-1/4"></span>
            </div>
        </div>
    </div>
